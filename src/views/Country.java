...
//       tregion_id.setText((String) tbl_countries.getValueAt(row, 2).toString());
    ...
    private void bt_add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_add1ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, id+" "+ name+ " "+ region_id);
        String a = countryController.selectById(id).getId();
//        if (id.equals(a)) {
//            JOptionPane.showMessageDialog(this, countryController.update(id, name, Integer.toString(region_id)));
//        } else {
//            JOptionPane.showMessageDialog(this, countryController.create(id, name, Integer.toString(region_id)));
//        }
        reset();
        bindingTabel();
